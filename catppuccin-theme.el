...
(let ((colors '((undef     "#ff00ff" "#ff00ff")
      ...
      (faces '(;; default / basic faces
               ...
               ;; erc
               (erc-current-nick-face :weight bold :foreground ,ctp-sky)
               (erc-dangerous-host-face :foreground ,ctp-red)
               (erc-direct-msg-face :foreground ,ctp-maroon)
               (erc-error-face :foreground ,ctp-red)
               (erc-fool-face :foreground ,ctp-surface2)
               (erc-header-line :foreground ,ctp-text :background ,ctp-mantle)
               (erc-input-face :foreground ,ctp-maroon)
               (erc-inverse-face :foreground ,ctp-base :background ,ctp-text)
               (erc-keyword-face :weight bold :foreground ,ctp-green)
               (erc-my-nick-face :weight bold :foreground ,ctp-red)
               (erc-nick-msg-face :weight bold :foreground ,ctp-maroon)
               (erc-notice-face :weight bold :foreground ,ctp-mauve)
               (erc-pal-face :weight bold :foreground ,ctp-pink)
               (erc-prompt-face :weight bold :foreground ,ctp-base :background ,ctp-lavender)
               (erc-timestamp-face :weight bold :foreground ,ctp-green)
               ...
               (fg:erc-color-face0 :background ,ctp-text)
               (fg:erc-color-face1 :background ,ctp-crust)
               (fg:erc-color-face2 :background ,ctp-blue)
               (fg:erc-color-face3 :background ,ctp-green)
               (fg:erc-color-face4 :background ,ctp-red)
               (fg:erc-color-face5 :background ,ctp-maroon)
               (fg:erc-color-face6 :background ,ctp-mauve)
               (fg:erc-color-face7 :background ,ctp-peach)
               (fg:erc-color-face8 :background ,ctp-yellow)
               (fg:erc-color-face9 :background ,ctp-green)
               (fg:erc-color-face10 :background ,ctp-lavender)
               (fg:erc-color-face11 :background ,ctp-teal)
               (fg:erc-color-face12 :background ,ctp-sapphire)
               (fg:erc-color-face13 :background ,ctp-pink)
               (fg:erc-color-face14 :background ,ctp-overlay2)
               (fg:erc-color-face15 :background ,ctp-text)
               ;; eshell
